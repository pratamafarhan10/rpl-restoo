@extends('layouts.kasir.app', ['title' => 'Pembayaran'])
...
<div class="container-md mt-3">
    ...
    <!-- History title -->
    <div class="row my-3">
        <h1 class="text-center title-fitur"><strong>Pembayaran</strong></h1>
    </div>
    ...
    <div class="row">
        <div class="card card-category mb-2">
            <div class="row my-auto fw-bold">
                ...
                <div class="col">
                    <form class="d-flex" action="{{ route('payment.search') }}" method="GET">
