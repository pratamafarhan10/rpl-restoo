                            ...
                            <div class="container">
                                <div class="input-group d-grid gap-2">
                                    <span class="input-group-btn mx-auto text-center">
                                        <button type="button" class="btn btn-secondary btn-number btn-pesan-number" disabled="disabled" data-type="minus" data-field="total[{{ str_replace(' ', '', $food->name)}}]">-</button>
                                    </span>
                                    <input type="text" name="total[{{ str_replace(' ', '', $food->name)}}]" class="form-control input-number my-2 text-center pesan-number" value="0" min="0" max="100">
                                    <span class="input-group-btn mx-auto text-center">
                                        <button type="button" class="btn btn-secondary btn-number btn-pesan-number" data-type="plus" data-field="total[{{ str_replace(' ', '', $food->name)}}]">+</button>
                                    </span>
                                </div>
                            </div>
                        </div>
